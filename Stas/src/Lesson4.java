...
public class Lesson4 {
    public static void main(String[] args) {
        ...
        int average;         // Переменная для поиска среднего значения выполненных заданий.
        average = summ / lengthOfPeriod;        // Рассчет среднего значения выполненных задач.
        System.out.println("Среднее количество выполненных задач в неделю за период равно: " + average);
